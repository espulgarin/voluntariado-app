        ...
        <div class="row">
          ...
          <!-- /.col -->
           ...
           <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Voluntarios registrados</span>
                <span class="info-box-number">
                  <?php echo $conn->query("SELECT * FROM attendees")->num_rows; ?>
                </span>
              </div>
              <!-- /.info-box-content -->
            </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Anuncios en total</span>
                <span class="info-box-number">
