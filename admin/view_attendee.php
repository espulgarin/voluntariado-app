...
<?php
if(isset($_GET['id'])){
	$qry = $conn->query("SELECT a.*,concat(a.firstname,' ',a.lastname) as name,e.event FROM attendees a inner join events e on e.id = a.event_id where a.id = ".$_GET['id'])->fetch_array();
foreach($qry as $k => $v){
	$$k = $v;
}
}
	...
	<div class="card card-widget widget-user shadow">
      ...
      <div class="card-footer">
        <div class="container-fluid">
        	<dl>
            <dt>Del programa</dt>
            <dd><?php echo ucwords($middlename) ?></dd>
            <dt>Sexo</dt>
            <dd><?php echo $gender ?></dd>
            <dt>Número de contacto</dt>
