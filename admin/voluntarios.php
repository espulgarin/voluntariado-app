	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=nuevo_voluntario"><i class="fa fa-plus"></i> Añadir nuevo</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$qry = $conn->query("SELECT a.*,concat(a.firstname,' ',a.lastname) as name,e.event FROM attendees a inner join events e on e.id = a.event_id order by unix_timestamp(e.date_created) desc ");
					...
					<tr>
						...
						<td class="text-center">
		                    <div class="btn-group">
		                        <a href="./index.php?page=editar_voluntario&id=<?php echo $row['id'] ?>" class="btn btn-primary btn-flat">
...
<script>
	...
	uni_modal("Detalles del voluntario","view_attendee.php?id="+$(this).attr('data-id'))
	})
