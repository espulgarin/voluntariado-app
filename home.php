  ...
  <div class="row">
    <div class="col-md-12 mb-4">
      ...
      <div class="input-group">
          <input type="search" id="filter" class="form-control form-control-lg" placeholder="Ingrese su búsqueda">
      ...
      <div class="row">
          <?php
            ...
            Éste query es para filtrar únicamente los que tengan una fecha de inicio menor a la actual, se deja para que muestre todos.
            */
            $events = $conn->query("SELECT * FROM events where id in (SELECT event_id from assigned_registrar where user_id = {$_SESSION['login_id']})");
          ...
          ?>
          <a class="event-item text-dark" href="./index.php?page=gestionar_anuncio&c=<?php echo md5($row['id']) ?>" data-id = '<?php echo $row['id'] ?>'>
